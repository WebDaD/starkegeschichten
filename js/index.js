...
function scrollTo (country) {
  ...
  switch (country) {
    ...
    case 'ec': element = ''; alert('Coming Soon...'); break
    case 'co': element = ''; alert('Coming Soon...'); break
    case 'mx': element = ''; alert('Coming Soon...'); break
    default: element = ''; break
  }
  if (element !== '') {
    history.pushState({}, 'Starke Geschichten', '#' + element)
